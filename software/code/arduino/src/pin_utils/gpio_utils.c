...
static Bool is_gpio_pin_input(volatile uint8_t* pin_ddr_ptr, uint8_t pin); 
static Bool is_gpio_pin_output(volatile uint8_t* pin_ddr_ptr, uint8_t pin);
...
{
    if(is_gpio_pin_output(pin_ddr_ptr, pin) == TRUE)
    {
...
int read_gpio_pin(volatile uint8_t* pin_ddr_ptr, volatile uint8_t* pin_input_register_ptr, uint8_t pin)
{
    ...
    if(is_gpio_pin_input(pin_ddr_ptr, pin) == TRUE)
    {
